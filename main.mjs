...
async function findPrivateKeyInReverseRange(startPrivateKey, userAddress) {
    ...
    let max = new BigNumber('0000000000001000000000000000000008000000000000000000000000000001', 16);
...
// Contoh penggunaan
const startPrivateKey = 'ffffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364140'; // Ganti dengan private key awal
